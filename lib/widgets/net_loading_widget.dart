...
import 'package:test_bloc/widgets/loading_widget.dart';
import 'package:dio/dio.dart';


class NetLoadingWidget extends StatefulWidget {
 const NetLoadingWidget({Key key, this.loadingController,
    this.successWidget, this.loadingText, this.errorText, this.successText, this.emptyText, this.idleText, this.onRequest, this.cancelToken, this.onSuccess,}) : super(key: key);
  ...
  String getLoadingText() {
    switch (loadingFlag) {
      case LoadingFlag.loading:
        return widget.loadingText ?? 'Espere un momento';
        break;
      case LoadingFlag.error:
        return widget.errorText ?? 'Ya llega';
        break;
      case LoadingFlag.success:
        return widget.successText ?? 'Correcto';
        break;
